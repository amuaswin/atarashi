...
let customStyles = {
  ...
  headCells: {
    styles: { color: "black", textAlign: "center", margin: "1rem" },
  },
  cells: {
    style: {
      color: "black",
...
function DataTables() {
  ...
  const handleDelete = (id) => {
    Swal.fire({
      title: "Are you sure?",
      text: "You wnat to delete this category.",
      icon: "warning",
      ...
      .then((result) => {
        if (result.isConfirmed) {
          axios
            .post("http://catodotest.elevadosoftwares.com/Category/RemoveCategory", { categoryId: id })
            .then(() => {
    ...
    if (input.categoryId !== 0) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios
            .post(
              "http://catodotest.elevadosoftwares.com/Category/InsertCategory", newRecord)
            .then(() => {
              axios
                .get("http://catodotest.elevadosoftwares.com/Category/GetAllCategories")
                .then((res) => {
  ...
  const handleUpdate = () => {
    ...
    axios
      .post(
        "http://catodotest.elevadosoftwares.com/Category/InsertCategory", updatedRecord)
      .then(() => {
        axios
          .get("http://catodotest.elevadosoftwares.com/Category/GetAllCategories")
          .then((res) => {
        ...
        Swal.fire({
          title: "Success!",
          text: "The data has updated successfully!",
          icon: "success",
        });
      })
      .catch((error) => {
